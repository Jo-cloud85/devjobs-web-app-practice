...
- In each company's website, there should be a map of the company's location which is obtained by calling the external map API
  - The map location is retrieved from calling an external API - Leaflet  
...
- Then this url, with other details, I can save to Redis and MySQL.
